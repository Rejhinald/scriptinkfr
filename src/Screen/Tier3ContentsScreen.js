...
function Tier3ContentsScreen() {
  ...
  useEffect(() => {
    async function fetchTierProducts() {
      const { data } = await axios.get(`https://scriptinkbk.pythonanywhere.com/api/tierproducts/3`);
...
export default Tier3ContentsScreen;
