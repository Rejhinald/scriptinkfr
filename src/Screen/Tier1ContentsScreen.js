...
function Tier1ContentsScreen() {
  ...
  useEffect(() => {
    async function fetchTierProducts() {
      const { data } = await axios.get(`https://scriptinkbk.pythonanywhere.com/api/tierproducts/1`);
...
export default Tier1ContentsScreen;
